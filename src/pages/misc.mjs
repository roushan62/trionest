    ...
    jsonld: [
      {
        ...
        publisher: {
          '@type': 'Organization',
          name: site.name,
          logo: { '@type': 'ImageObject', url: site.url + '/assets/brand/logo.png' },
        },
...
export const contact = page({
  ...
  desc: 'Request a free site survey and a fixed-cost proposal for interiors, electrical or HVAC scope. Call +91 87965 75719 or email spaces@trionest.in.',
  path: '/contact/',
